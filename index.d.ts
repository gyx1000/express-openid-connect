...
interface ConfigParams {
  ...
  backchannelLogout?:
    ...
    | {
        /**
         * Used to store Back-Channel Logout tokens, you can specify a separate store
         ...
         * (See {@link ./examples/backchannel-logout-custom-genid.js} or {@link ./examples/backchannel-logout-custom-query-store.js})
         */
        onLogoutToken?: (
          token: string,
          config: ConfigParams
